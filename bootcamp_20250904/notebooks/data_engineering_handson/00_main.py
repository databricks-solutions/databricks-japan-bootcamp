...
DEV001,2024-01-02 10:01:00,"",70.1,inactive
DEV001,2024-01-03 10:02:00,25.8," ",active
DEV001,2024-01-04 10:03:00,N/A,68.9,error
DEV001,2024-01-05 10:04:00,24.7,N/A,active
DEV002,2024-01-01 10:00:00,26.3,71.2,
DEV002,2024-01-02 10:01:00,22.8,63.5,active
DEV002,2024-01-03 10:02:00,25.1,67.9,maintenance
DEV002,2024-01-04 10:03:00,"",64.8,active
DEV002,2024-01-05 10:04:00,24.3,N/A,inactive"""
...
# MAGIC %md
# MAGIC ## Additional work: 上記ジョブに新規taskを追加
# MAGIC 上記で手動作成したジョブに、Silver tableから統計値を計算したGold tableを作成するタスクを追加してください。
# MAGIC
# MAGIC 💡 **Hint**:  
# MAGIC Scriptは自由に考えて作成していただいて大丈夫ですが、  
# MAGIC 例えば、Catalogのサンプルデータを見ると、AI Assistantが分析スクリプトを提案してくれますので、参考にしてください。
