...
2026年1月13日開催のDatabricks Boot Campで使用する資料のリンクをまとめています。
...
- csvファイルをダウンロード
    - https://github.com/databricks-solutions/databricks-japan-bootcamp/blob/main/bootcamp_20260113/notebooks/aibi/00_call.csv
